        ...
        <header className='flex justify-between px-10 py-4 items-center text-fondo-dark font-bold bg-fondo-light '>
            ...
            <nav className="max-lg:hidden">
                <ul className="flex gap-5 ">
                    <li className="px-3 py-2 hover:bg-primary hover:text-white rounded-3xl hover:scale-105 transition-all"><a href="#Inicio">Inicio</a></li>
                    <li className="px-3 py-2 hover:bg-primary hover:text-white rounded-3xl hover:scale-105 transition-all"><a href="#Servicios">Servicios</a></li>
                    <li className="px-3 py-2 hover:bg-primary hover:text-white rounded-3xl hover:scale-105 transition-all"><a href="#Nosotros">Nosotros</a></li>
            ...
            <button
                ...
                className="lg:hidden block hover:scale-105 transition-all cursor-pointer ">
                <Menu />
            </button>
            ...
            <div className={`flex flex-col gap-5 md:hidden bg-white absolute top-14 left-0 w-full z-20 transition-all duration-300 ${isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible"}`}>
                <ul className="w-full text-center">
                    ...
                    <li className="px-3 py-4 w-full list-none hover:bg-primary hover:text-white hover:scale-105 transition-all cursor-pointer"><a href="#Servicios">Servicios</a></li>
                    <li className="px-3 py-4 w-full list-none hover:bg-primary hover:text-white hover:scale-105 transition-all cursor-pointer"><a href="#Nosotros">Nosotros</a></li>
                    <li className="px-3 py-4 w-full list-none hover:bg-primary hover:text-white hover:scale-105 transition-all cursor-pointer"><a href="#Contactos">Contactos</a></li>
                    <li className="px-3 py-4 w-full list-none hover:bg-primary hover:text-white hover:scale-105 transition-all cursor-pointer">
                        <Link to="/menu" className="block w-full">Ver menu</Link>
                    </li>
                    <li className="px-3 py-4 w-full list-none hover:bg-primary hover:text-white hover:scale-105 transition-all cursor-pointer">
